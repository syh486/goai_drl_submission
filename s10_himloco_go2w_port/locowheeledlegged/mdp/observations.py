...
from isaaclab.utils.math import quat_inv, quat_mul, quat_rotate_inverse, quat_from_euler_xyz
if TYPE_CHECKING:
...
def base_lin_acc(
    ...
    return math_utils.quat_rotate_inverse(body_quat, base_lin_acc_w)
