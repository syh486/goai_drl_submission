...
def terrain_levels_vel(
    ...
    # Match the official M20 update lifecycle: refresh the shared gait scale
    # once when terrain levels change, then let all reward terms reuse it.
    from .rewards import update_terrain_curriculum_scale

    update_terrain_curriculum_scale(env, mean_level)
    return mean_level
